...
class TestContributePage(TestUtilities):
    ...
    def test_contribute_page_text(self):
        ...
        self.sumo_pages.top_navbar.click_on_contribute_top_navbar_option()

        self.logger.info("Verifying that the correct page hero header text is displayed")
        check.equal(
            self.sumo_pages.contribute_page.get_page_hero_main_header_text(),
            ContributePageMessages.HERO_MAIN_PAGE_TITLE,
            f"Text is: {self.sumo_pages.contribute_page.get_page_hero_main_header_text()} "
        ...
        check.equal(
            self.sumo_pages.contribute_page.get_page_hero_main_subtext(),
            ContributePageMessages.HERO_HELP_MILLION_OF_USERS_TEXT,
            f"Text is: {self.sumo_pages.contribute_page.get_page_hero_main_subtext()} "
        ...
        check.equal(
            self.sumo_pages.contribute_page.get_page_hero_need_help_header_text(),
            ContributePageMessages.HERO_NEED_YOUR_HELP_TITLE,
            f"Text is: "
            f"{self.sumo_pages.contribute_page.get_page_hero_need_help_header_text()}"
        ...
        check.equal(
            self.sumo_pages.contribute_page.get_page_hero_need_help_subtext(),
            ContributePageMessages.HERO_NEED_YOUR_HELP_PARAGRAPH,
            f"Text is: {self.sumo_pages.contribute_page.get_page_hero_need_help_subtext()}."
        ...
        check.equal(
            self.sumo_pages.contribute_page.get_way_to_contribute_header_text(),
            ContributePageMessages.PICK_A_WAY_TO_CONTRIBUTE_HEADER,
            f"Text is: {self.sumo_pages.contribute_page.get_way_to_contribute_header_text()}"
        ...
        check.equal(
            card_titles,
            self.sumo_pages.contribute_page.get_way_to_contribute_card_titles_text(),
        ...
        check.equal(
            self.sumo_pages.contribute_page.get_about_us_header_text(),
            ContributePageMessages.ABOUT_US_HEADER,
            f"Text is: {self.sumo_pages.contribute_page.get_about_us_header_text()}"
        ...
        check.equal(
            self.sumo_pages.contribute_page.get_about_us_subtext(),
            ContributePageMessages.ABOUT_US_CONTENT,
            f"Text is: {self.sumo_pages.contribute_page.get_about_us_subtext()}"
    ...
    def test_contribute_page_images_are_not_broken(self):
        ...
        for link in self.sumo_pages.contribute_page.get_all_page_links():
    ...
    def test_contribute_page_breadcrumbs(self):
        ...
        check.equal(
            self.sumo_pages.contribute_page.get_breadcrumbs_text(),
            breadcrumbs,
            f"Breadcrumbs are: {self.sumo_pages.contribute_page.get_breadcrumbs_text()}"
    ...
    def test_way_to_contribute_redirects_to_correct_page(self):
        ...
        counter = 0
        for element in self.sumo_pages.contribute_page.get_list_of_contribute_cards():
            card = self.sumo_pages.contribute_page.get_list_of_contribute_cards()[counter]
            self.sumo_pages.contribute_page.click_on_way_to_contribute_card(card)
            check.equal(
